...
接雨水的问题，我是看到 leetcode 第 11 题，盛水最多的容器，看完这道题我就懵了。这怎么解，完全陷入题目的思维当中不能自拔，没有办法跳出来思考数组常用的解法：双指针，前后指针，二分法，滑动窗口这些，这也难怪，我刚从链表那里过来，直接看数组的，确实可能思维固定了。点开阿东的解题文章，重新记录笔记和思维扩散过程吧，没办法，还是得多练
